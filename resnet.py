...
from de_resnet import ones_init, zero_init, kaiming_normal_init
...
class Bottleneck(nn.Layer):
    # Bottleneck in paddle.vision places the stride for downsampling at 3x3 convolution(self.conv2)
